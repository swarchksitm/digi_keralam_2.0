...
from .views import DistrictListView, BlockListView, LSGIListView, WardListView, LSGIDetailView, LSGIDetailView
...
urlpatterns = [
    ...
    path('lsgis/<int:pk>/', LSGIDetailView.as_view(), name='lsgi_detail'),
