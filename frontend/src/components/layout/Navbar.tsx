                ...
                <div className="flex justify-between h-20">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            <Link
                                to={isAuthenticated && user?.role ? getDashboardPath(user.role) : "/"}
                    ...
                    <div className="flex items-center gap-4">
                        <button className="flex items-center gap-2 text-gray-600 hover:text-primary-700 px-3 py-1.5 rounded-full hover:bg-primary-50 transition-all text-sm font-medium border border-transparent hover:border-primary-100">
